		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Recording WE-Foreign",
									"targetURL": "#zrecweforeign-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zrecweforeign-display": {
								"semanticObject": "zrecweforeign",
								"action": "display",
								"description": "Recording WE-Foreign application.",
								"title": "Recording WE-Foreign",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z.recweforeign",
									"url": sap.ui.require.toUrl("z/recweforeign")
								}
							}
						}
					}
