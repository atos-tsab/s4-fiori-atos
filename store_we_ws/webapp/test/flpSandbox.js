					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Storage from WE/QS",
									"targetURL": "#zstorewews-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zstorewews-display": {
								"semanticObject": "zstorewews",
								"action": "display",
								"description": "Storage from WE/QS application.",
								"title": "Storage from WE/QS",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z.storewews",
									"url": sap.ui.require.toUrl("z/storewews")
								}
							}
						}
					}
