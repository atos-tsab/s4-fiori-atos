...
sap.ui.define([
	...
	var _fragmentPath   = "z.confstorage.controls.fragments.";
	var _sAppModulePath = "z/confstorage/";
	var APP = "CONF_STOR";


    return Control.extend("z.confstorage.controls.ExtScanner", {
		...
		_setKeyboardShortcuts: function() {
			...
			$(document).keydown($.proxy(function (evt) {
                ...
                var controlF1 = sap.ui.getCore().byId("__scanner0--idButtonOk_CONF_STOR");
                var controlF2 = sap.ui.getCore().byId("__scanner0--idButtonScanOk_CONF_STOR");
