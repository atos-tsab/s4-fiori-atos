		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Confirmation and Storage",
									"targetURL": "#zconfstorage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zconfstorage-display": {
								"semanticObject": "zconfstorage",
								"action": "display",
								"description": "Confirmation and Storage application.",
								"title": "Confirmation and Storage",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z.confstorage",
									"url": sap.ui.require.toUrl("z/confstorage")
								}
							}
						}
					}
