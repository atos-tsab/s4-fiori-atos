		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zshippingcust-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zshippingcust-display": {
								"semanticObject": "zshippingcust",
								"action": "display",
								"description": "Shipping Customs application.",
								"title": "Shipping Customs",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z.shippingcust",
									"url": sap.ui.require.toUrl("z/shippingcust")
								}
							}
						}
					}
