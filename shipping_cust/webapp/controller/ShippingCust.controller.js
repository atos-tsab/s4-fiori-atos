 ...
 ************************************************************************
 * Description    : BPW - eEWM - Mobile App Shipping Customs
 ************************************************************************
...
sap.ui.define([
    "z/shippingcust/controls/ExtScanner",
    "z/shippingcust/model/formatter",
    "z/shippingcust/utils/tools",
    ...
    var _sAppPath       = "z.shippingcust.";
    var _fragmentPath   = "z.shippingcust.view.fragments.";
    var _sAppModulePath = "z/shippingcust/";

    var APP = "SHIP_CUST";


    return Controller.extend("z.shippingcust.controller.ShippingCust", {
        ...
        _updateStatusSingleHU: function (iHU) {
            ...
            var sPath = "/DeliveryHU(WarehouseNumber='" + this.sWN + "',HandlingUnitId='" + iHU + "')";
