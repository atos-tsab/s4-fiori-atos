...
sap.ui.define([
    "sap/ui/core/Control",
	"z/shippingcust/model/formatter",
    "jquery.sap.global",
	...
	var _fragmentPath   = "z.shippingcust.controls.fragments.";
	var _sAppModulePath = "z/shippingcust/";
	var APP = "SHIP_CUST";


    return Control.extend("z.shippingcust.controls.ExtScanner", {
        ...
        _redefineTitles: function () {
            var titleTR = this.getResourceBundle().getText("TitleInputDialogTR");
            var titleHU = this.getResourceBundle().getText("TitleInputDialogHU");

            var lblTR   = this.getResourceBundle().getText("ShipmentNumber");
            ...
            if (this.sScanView === "Handling") {
                ...
                this._oScanModel.setProperty("/titleDialog", titleTR);
                this._oScanModel.setProperty("/labelDialog", lblTR);
            }
		...
		_setKeyboardShortcuts: function() {
			...
			$(document).keydown($.proxy(function (evt) {
                ...
                var controlF1 = sap.ui.getCore().byId("__scanner0--idButtonOk_SHIP_CUST");
                var controlF2 = sap.ui.getCore().byId("__scanner0--idButtonScanOk_SHIP_CUST");
