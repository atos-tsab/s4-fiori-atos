					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Warehouse task from HHU",
									"targetURL": "#zwafromhhu-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zwafromhhu-display": {
								"semanticObject": "zwafromhhu",
								"action": "display",
								"description": "eEWM Mobile Fiori Apps",
								"title": "Warehouse task from HHU",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z.wafromhhu",
									"url": sap.ui.require.toUrl("z/wafromhhu")
								}
							}
						}
					}
