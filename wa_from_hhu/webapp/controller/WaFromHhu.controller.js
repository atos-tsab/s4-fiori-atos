...
sap.ui.define([
    "z/wafromhhu/controller/BaseController",
    "z/wafromhhu/controls/ExtScanner",
    "z/wafromhhu/model/formatter",
    "z/wafromhhu/utils/tools",
    ...
    var _fragmentPath   = "z.wafromhhu.view.fragments.";
	var _sAppModulePath = "z/wafromhhu/";
    var APP = "WA_FROM_HHU";


    return BaseController.extend("z.wafromhhu.controller.WaFromHhu", {
        ...
        onPressBooking: function () {
            var sOpenWarehouseTaskErr = this.getResourceBundle().getText("OpenWarehouseTaskErr");
            var sWhtType = "H";
            ...
            if (this.StatusOpenWarehouseTask) {
                ...
                this._createWarehouseTask(sWhtType);
            }
        },
        ...
        _createWarehouseTask: function (sWhtType) {
