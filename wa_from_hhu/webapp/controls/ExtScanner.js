...
sap.ui.define([
	...
	var _fragmentPath   = "z.wafromhhu.controls.fragments.";
	var _sAppModulePath = "z/wafromhhu/";
	var APP = "WA_FROM_HHU";


    return Control.extend("z.wafromhhu.controls.ExtScanner", {
		...
		_setKeyboardShortcuts: function() {
			...
			$(document).keydown($.proxy(function (evt) { 
                ...
                var controlF1 = sap.ui.getCore().byId("__scanner0--idButtonOk_WA_FROM_HHU");
                var controlF2 = sap.ui.getCore().byId("__scanner0--idButtonScanOk_WA_FROM_HHU");
