		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Queue-based Processing of Warehouse tasks",
									"targetURL": "#zqbasedwareproc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zqbasedwareproc-display": {
								"semanticObject": "zqbasedwareproc",
								"action": "display",
								"description": "Queue-based Processing of Warehouse tasks application.",
								"title": "Queue-based Processing of Warehouse tasks",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z.qbasedwareproc",
									"url": sap.ui.require.toUrl("z/qbasedwareproc")
								}
							}
						}
					}
