...
sap.ui.define([
	...
	var _fragmentPath   = "z.delivery.controls.fragments.";
	var _sAppModulePath = "z/delivery/";
	var APP = "DELIV";


    return Control.extend("z.delivery.controls.ExtScanner", {
        ...
        _removePrefix: function (key) {
            ...
            if ((this.sScanView === "Material" && key.startsWith("P")) || 
                ...
                this._oScanModel.setProperty("/valueSuffix", key.slice(0, 1));
        ...
        _redefineTitles: function () {
            var titleGate = this.getResourceBundle().getText("TitleInputDialogGate");
            var titleHU   = this.getResourceBundle().getText("TitleInputDialog");

            var lblGa = this.getResourceBundle().getText("Gate");
            ...
            if (this.sScanView === "Gate") {
                this._oScanModel.setProperty("/titleDialog", titleGate);
                this._oScanModel.setProperty("/labelDialog", lblGa);
                this._oScanModel.setProperty("/lblWidth", "50px");
            } else if (this.sScanView === "Handling") {
		...
		_setKeyboardShortcuts: function() {
			...
			$(document).keydown($.proxy(function (evt) {
                ...
                var controlF1 = sap.ui.getCore().byId("__scanner0--idButtonOk_DELIV");
                var controlF2 = sap.ui.getCore().byId("__scanner0--idButtonScanOk_DELIV");
