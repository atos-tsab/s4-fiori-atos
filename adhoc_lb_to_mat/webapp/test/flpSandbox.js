		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ad-hoc LB-Attachment to the Material",
									"targetURL": "#zadhoclbtomat-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zadhoclbtomat-display": {
								"semanticObject": "zadhoclbtomat",
								"action": "display",
								"description": "Ad-hoc LB-Attachment to the Material application.",
								"title": "Ad-hoc LB-Attachment to the Material",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z.adhoclbtomat",
									"url": sap.ui.require.toUrl("z/adhoclbtomat")
								}
							}
						}
					}
