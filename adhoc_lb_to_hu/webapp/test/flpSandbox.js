		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ad-hoc LB-Attachment to the HU",
									"targetURL": "#zadhoclbtohu-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zadhoclbtohu-display": {
								"semanticObject": "zadhoclbtohu",
								"action": "display",
								"description": "Ad-hoc LB-Attachment to the HU application.",
								"title": "Ad-hoc LB-Attachment to the HU",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z.adhoclbtohu",
									"url": sap.ui.require.toUrl("z/adhoclbtohu")
								}
							}
						}
					}
