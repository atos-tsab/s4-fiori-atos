			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zrearrangem-display": {
								"semanticObject": "zrearrangem",
								"action": "display",
								"description": "eEWM Mobile Fiori App - Loading internal rearrangements",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z.rearrangem",
									"url": sap.ui.require.toUrl("z/rearrangem")
								}
							}
						}
					}
