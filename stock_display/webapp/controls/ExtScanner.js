...
sap.ui.define([
	...
	var _fragmentPath   = "z.stockdisplay.controls.fragments.";
	var _sAppModulePath = "z/stockdisplay/";
	var APP = "STOC_DISP";


    return Control.extend("z.stockdisplay.controls.ExtScanner", {
        ...
        _redefineTitles: function () {
            var title = this.getResourceBundle().getText("TitleInputDialog");
            var lblDiverse = this.getResourceBundle().getText("Material");
            
            this._oScanModel.setProperty("/okButton", false);
            this._oScanModel.setProperty("/lblWidth", "120px");
            this._oScanModel.setProperty("/titleDialog", title);
            this._oScanModel.setProperty("/labelDialog", lblDiverse);
        },
		...
		_setKeyboardShortcuts: function() {
			...
			$(document).keydown($.proxy(function (evt) { 
                ...
                var controlF1 = sap.ui.getCore().byId("__scanner0--idButtonOk_STOC_DISP");
                var controlF2 = sap.ui.getCore().byId("__scanner0--idButtonScanOk_STOC_DISP");
