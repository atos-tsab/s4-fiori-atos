...
sap.ui.define([
	...
	var _fragmentPath   = "z.loadtransport.controls.fragments.";
	var _sAppModulePath = "z/loadtransport/";
	var APP = "LOAD_TRANSP";


    return Control.extend("z.loadtransport.controls.ExtScanner", {
		...
		_setKeyboardShortcuts: function() {
			...
			$(document).keydown($.proxy(function (evt) {
                ...
                var controlF1 = sap.ui.getCore().byId("__scanner0--idButtonOk_LOAD_TRANSP");
                var controlF2 = sap.ui.getCore().byId("__scanner0--idButtonScanOk_LOAD_TRANSP");
