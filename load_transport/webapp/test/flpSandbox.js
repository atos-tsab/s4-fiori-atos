		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Loading for transport",
									"targetURL": "#zloadtransport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zloadtransport-display": {
								"semanticObject": "zloadtransport",
								"action": "display",
								"description": "Loading for transport application.",
								"title": "Loading for transport",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z.loadtransport",
									"url": sap.ui.require.toUrl("z/loadtransport")
								}
							}
						}
					}
